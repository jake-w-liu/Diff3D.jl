...
| R2 | Correct public documentation, examples, and installation instructions; execute consumer-facing examples; build strict docs with no stale API references. | In progress | Executable documentation exposed a missing direct example dependency; corrected build is running |
