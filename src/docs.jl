...
const _API_TYPE_DOCS = Dict{Symbol,String}(
    ...
    :MeshLambertMaterial => "Diffuse Lambert material with optional normal maps for light-dependent matte shading.",
    :MeshPhongMaterial => "Phong material with diffuse/specular highlights, optional normal maps, vertex colors, and local clipping planes.",
