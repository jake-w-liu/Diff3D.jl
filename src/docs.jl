...
const _API_FUNCTION_DOCS = Dict{Symbol,String}(
    ...
    :load_svg => "Load common SVG paths and primitives into an SVG document.",
...
const _GENERIC_DOCS = Dict{Symbol,String}(
    ...
    :SVGDocument => "Decoded SVG document with common primitives converted to paths.",
    :SVGLoader => "Load common SVG paths and primitives into an SVG document.",
